...
const styles = StyleSheet.create({
  ...
  mapPulse: { position: "absolute", right: 18, top: 18, width: 9, height: 9, borderRadius: radii.pill, backgroundColor: colors.primary, boxShadow: "0 0 20px rgba(154, 105, 255, 0.66)" },
