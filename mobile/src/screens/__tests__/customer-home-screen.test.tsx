...
describe("CustomerHomeScreen", () => {
  ...
  it("shows a clear live request hub after the captain accepts the request", async () => {
    ...
    expect(screen.getByText("تابع موقع الكابتن والمسافة حتى يصل إليك")).toBeTruthy();
  });
