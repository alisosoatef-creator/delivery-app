...
export function useDriverData({ enabled = true, driverId = "", phone = "", cityId = "", token = "", role = "driver", userId = "" } = {}) {
  ...
  return {
    ...
    dispatchReason: availableRidesQuery.data?.dispatchReason || "",
    dispatchSort: availableRidesQuery.data?.dispatchSort || "",
    dispatchActiveRide: availableRidesQuery.data?.activeRide || null,
